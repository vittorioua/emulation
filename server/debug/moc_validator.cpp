...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Validator_t, stringdata) + ofs \
...
const QMetaObject Validator::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Validator.data,
      qt_meta_data_Validator,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Validator.stringdata))
